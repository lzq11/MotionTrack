...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default='pretrain/yolov7-w6.pt',
                        help='initial weights path')
    parser.add_argument('--cfg', type=str,
                        default='cfg/training/yolov7-w6.yaml',
                        help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='data/jmt2022.yaml',
                        help='data.yaml path')
    parser.add_argument('--hyp', type=str,
                        default='data/hyp.jmt2022.p6.yaml',
    ...
    parser.add_argument('--img-size', nargs='+', type=int,
                        default=[1920, 1920], help='[train, test] image sizes')
    ...
    parser.add_argument('--name', default='yolov7-w6',
                        help='save to project/name')
